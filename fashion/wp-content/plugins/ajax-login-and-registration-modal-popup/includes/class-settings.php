...
//        require_once LRM_PATH .  "/includes/settings/class-settings-field--editor.php";
    ...
    public function beg_for_review() {
        ...
        if ( lrm_is_pro() ) {
            ...
            if ( ! lrm_is_pro( '1.27' ) && !defined("LRM_HIDE_PRO_UPDATE_NOTICE") ) {
...
//            ) );
        ...
        $EMAILS_SECTION->add_group( __( 'Registration', 'ajax-login-and-registration-modal-popup' ), 'registration' )
            ...
            ->add_field( array(
                ...
                'description' => 'The email Body to user about successful registration. Allowed tags: {{SITE_NAME}}, {{SITE_URL}}, {{USERNAME}}, {{PASSWORD}}, {{LOGIN_URL}}, {{VERIFY_ACCOUNT_URL}} (only for PRO)',
